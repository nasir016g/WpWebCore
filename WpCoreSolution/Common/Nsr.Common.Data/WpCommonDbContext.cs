...
{
    public class WpCommonDbContext : DbContext//, IDbContext
    {
        ...
        public WpCommonDbContext(DbContextOptions<WpCommonDbContext> options) : base(options)
        {
            //Database.EnsureCreated();
        }

        public WpCommonDbContext(DbContextOptions<WpCommonDbContext> options, string connectionString) : base(options)
        {
